...
if __name__ == '__main__':
    ...
    # return [[crop1, fill1], [crop2, fill2],...]2
    ...
    def define_my_crop_strategy(img, instance):
        pass
    # 截图并保存
    imgs_crop_and_fill(img_folder_path='/home/adt/data/data/weiruan/weiruan_a/select_daowen_new/val',
                       # 自定义的截图策略
                       crop_stategy=aug_crop_strategy,
                       # 截图输出路径
                       output_path='/home/adt/data/data/weiruan/weiruan_a/select_daowen_new/val/crop_1536',
                       # 自动滤去不含检测目标的截图框
                       empty_check=True,
