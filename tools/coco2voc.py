...
CKimg_dir ='/home/zhang/datasets/bottle/voc/images'
CKanno_dir = '/home/zhang/datasets/bottle/voc/annotations'
...
def main():
    base_dir='/home/zhang/datasets/bottle/voc'#step1 这里是一个新的文件夹，存放转换后的图片和标注
    image_dir=os.path.join(base_dir,'images')#在上述文件夹中生成images，annotations两个子文件夹
    anno_dir=os.path.join(base_dir,'annotations')
    mkr(image_dir)
    mkr(anno_dir)
    origin_image_dir='/home/zhang/datasets/bottle'#step 2原始的coco的图像存放位置
    origin_anno_dir='/home/zhang/datasets/bottle/annotations'#step 3 原始的coco的标注存放位置
