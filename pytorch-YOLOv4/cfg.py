...
Cfg.train_label = os.path.join(_BASE_DIR, 'data', '/home/zhang/defect_detection/pytorch-YOLOv4/tool/myData_train.txt')
Cfg.val_label = os.path.join(_BASE_DIR, 'data' ,'/home/zhang/defect_detection/pytorch-YOLOv4/tool/myData_val.txt')
