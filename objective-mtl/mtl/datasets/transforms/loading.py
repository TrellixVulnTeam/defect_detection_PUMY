...
class LoadMultiChannelImageFromFiles:
    ...
    Required keys are "img_prefix" and "file_name",
    which is expected to be a list of filenames).
    Added or updated keys are "file_name", "img", "img_shape",
    ...
    Args:
        ...
        file_client_args (dict): Arguments to instantiate a FileClient.
            See :class:`FileClient` for details.
    ...
    def __call__(self, results):
        ...
        if results["img_prefix"] is not None:
            filename = [
                osp.join(results["img_prefix"], fname) for fname in results["file_name"]
            ]
        else:
...
class LoadAnnotations:
    ...
    def _load_labels(self, results):
        ...
        """
        results["gt_labels"] = results["ann"]["labels"].copy()
        return results
