...
class CornerNet(SingleStageDetector):
    ...
    def __init__(self, cfg):
        super(CornerNet, self).__init__(cfg)

    def _merge_aug_results(self, aug_results, img_metas):
        ...
        for bboxes_labels, img_info in zip(aug_results, img_metas):
            img_shape = img_info["img_shape"]  # using shape before padding
    ...
    def aug_test(self, imgs, img_metas, rescale=False):
        ...
        bboxes, labels = self._merge_aug_results(aug_results, img_metas)
