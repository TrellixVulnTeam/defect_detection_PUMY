...
class ATSSPartFixedAdapter(SingleStageDetector):
    """Fix part of model for atss adapter"""
    ...
    def __init__(self, cfg):
        ...
        self.adapter = build_neck(cfg.ADAPTER)
    ...
    def forward_train(
        ...
        bk_feats, neck_feats = self.extract_feat_ext(img)
        x = self.adapter(bk_feats, neck_feats)
