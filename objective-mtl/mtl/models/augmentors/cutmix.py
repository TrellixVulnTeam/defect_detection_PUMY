...
class BaseCutMixLayer(object, metaclass=ABCMeta):
    ...
    def __init__(
        self, alpha, num_classes, prob=1.0, cutmix_minmax=None, correct_lam=True
    ):
    ...
    def rand_bbox_minmax(self, img_shape, count=None):
        ...
        percent values applied to each dimension of the input image. Typical
        defaults for minmax are usually in the  .2-.3 for min and.
...
class BatchCutMix(BaseCutMixLayer):
    """CutMix layer for batch CutMix."""

    def __init__(self, *args, **kwargs):
        super(BatchCutMix, self).__init__(*args, **kwargs)
