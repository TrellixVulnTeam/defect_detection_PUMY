...
DESCRIPTOR = _descriptor.FileDescriptor(
    name="wy_feature.proto",
    package="weiyi_tf",
    syntax="proto3",
    serialized_pb=_b(
        '\n\x10wy_feature.proto\x12\x08weiyi_tf"\x1a\n\tBytesList\x12\r\n\x05value\x18\x01 \x03(\x0c"\x1e\n\tFloatList\x12\x11\n\x05value\x18\x01 \x03(\x02\x42\x02\x10\x01"\x1e\n\tInt64List\x12\x11\n\x05value\x18\x01 \x03(\x03\x42\x02\x10\x01"\x92\x01\n\x07\x46\x65\x61ture\x12)\n\nbytes_list\x18\x01 \x01(\x0b\x32\x13.weiyi_tf.BytesListH\x00\x12)\n\nfloat_list\x18\x02 \x01(\x0b\x32\x13.weiyi_tf.FloatListH\x00\x12)\n\nint64_list\x18\x03 \x01(\x0b\x32\x13.weiyi_tf.Int64ListH\x00\x42\x06\n\x04kind"\x7f\n\x08\x46\x65\x61tures\x12\x30\n\x07\x66\x65\x61ture\x18\x01 \x03(\x0b\x32\x1f.weiyi_tf.Features.FeatureEntry\x1a\x41\n\x0c\x46\x65\x61tureEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12 \n\x05value\x18\x02 \x01(\x0b\x32\x11.weiyi_tf.Feature:\x02\x38\x01"1\n\x0b\x46\x65\x61tureList\x12"\n\x07\x66\x65\x61ture\x18\x01 \x03(\x0b\x32\x11.weiyi_tf.Feature"\x98\x01\n\x0c\x46\x65\x61tureLists\x12=\n\x0c\x66\x65\x61ture_list\x18\x01 \x03(\x0b\x32\'.weiyi_tf.FeatureLists.FeatureListEntry\x1aI\n\x10\x46\x65\x61tureListEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12$\n\x05value\x18\x02 \x01(\x0b\x32\x15.weiyi_tf.FeatureList:\x02\x38\x01\x42\x03\xf8\x01\x01\x62\x06proto3'
    ),
)

_BYTESLIST = _descriptor.Descriptor(
    name="BytesList",
    full_name="weiyi_tf.BytesList",
    filename=None,
    file=DESCRIPTOR,
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="value",
            full_name="weiyi_tf.BytesList.value",
            index=0,
            number=1,
            type=12,
            cpp_type=9,
...
_FLOATLIST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="value",
            full_name="weiyi_tf.FloatList.value",
            index=0,
            number=1,
            type=2,
            cpp_type=6,
...
_INT64LIST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="value",
            full_name="weiyi_tf.Int64List.value",
            index=0,
            number=1,
            type=3,
            cpp_type=2,
...
_FEATURE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="bytes_list",
            full_name="weiyi_tf.Feature.bytes_list",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="float_list",
            full_name="weiyi_tf.Feature.float_list",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="int64_list",
            full_name="weiyi_tf.Feature.int64_list",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="kind",
            full_name="weiyi_tf.Feature.kind",
            index=0,
            containing_type=None,
            fields=[],
        )
...
_FEATURES_FEATUREENTRY = _descriptor.Descriptor(
    name="FeatureEntry",
    full_name="weiyi_tf.Features.FeatureEntry",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="weiyi_tf.Features.FeatureEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="weiyi_tf.Features.FeatureEntry.value",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_FEATURES = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="feature",
            full_name="weiyi_tf.Features.feature",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_FEATURELIST = _descriptor.Descriptor(
    name="FeatureList",
    full_name="weiyi_tf.FeatureList",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="feature",
            full_name="weiyi_tf.FeatureList.feature",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_FEATURELISTS_FEATURELISTENTRY = _descriptor.Descriptor(
    ...
    full_name="weiyi_tf.FeatureLists.FeatureListEntry",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="weiyi_tf.FeatureLists.FeatureListEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="weiyi_tf.FeatureLists.FeatureListEntry.value",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_FEATURELISTS = _descriptor.Descriptor(
    name="FeatureLists",
    full_name="weiyi_tf.FeatureLists",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="feature_list",
            full_name="weiyi_tf.FeatureLists.feature_list",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_FEATURELISTS.fields_by_name[
    "feature_list"
].message_type = _FEATURELISTS_FEATURELISTENTRY
...
BytesList = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        ...
        __module__="wy_feature_pb2"
        # @@protoc_insertion_point(class_scope:weiyi_tf.BytesList)
    ),
)
...
FloatList = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        ...
        __module__="wy_feature_pb2"
        # @@protoc_insertion_point(class_scope:weiyi_tf.FloatList)
    ),
)
...
Int64List = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        ...
        __module__="wy_feature_pb2"
        # @@protoc_insertion_point(class_scope:weiyi_tf.Int64List)
    ),
)
...
Feature = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        DESCRIPTOR=_FEATURE,
        __module__="wy_feature_pb2"
        # @@protoc_insertion_point(class_scope:weiyi_tf.Feature)
    ),
)
    ...
    dict(
        FeatureEntry=_reflection.GeneratedProtocolMessageType(
            ...
            dict(
                ...
                __module__="wy_feature_pb2"
                # @@protoc_insertion_point(class_scope:weiyi_tf.Features.FeatureEntry)
            ),
        ),
        DESCRIPTOR=_FEATURES,
        __module__="wy_feature_pb2"
        # @@protoc_insertion_point(class_scope:weiyi_tf.Features)
    ),
)
...
FeatureList = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        ...
        __module__="wy_feature_pb2"
        # @@protoc_insertion_point(class_scope:weiyi_tf.FeatureList)
    ),
)
    ...
    dict(
        FeatureListEntry=_reflection.GeneratedProtocolMessageType(
            ...
            dict(
                ...
                __module__="wy_feature_pb2"
                # @@protoc_insertion_point(class_scope:weiyi_tf.FeatureLists.FeatureListEntry)
            ),
        ),
        DESCRIPTOR=_FEATURELISTS,
        __module__="wy_feature_pb2"
        # @@protoc_insertion_point(class_scope:weiyi_tf.FeatureLists)
    ),
)
