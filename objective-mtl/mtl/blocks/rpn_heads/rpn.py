...
from mtl.cores.ops import batched_nms
from ..block_builder import HEADS
from .anchor import AnchorHead
from .rpn_test_mixins import RPNTestMixin
...
class RPNHead(RPNTestMixin, AnchorHead):
    ...
    def get_losses(
        self, cls_scores, bbox_preds, gt_bboxes, img_metas, gt_bboxes_ignore=None
    ):
        ...
        """
        losses = super(RPNHead, self).get_losses(
            cls_scores,
            bbox_preds,
            gt_bboxes,
            None,
    ...
    def _get_bboxes_single(
        ...
        for idx in range(len(cls_scores)):
            ...
            if self.use_sigmoid_cls:
                ...
                # num_class in RPN head, which is unified to
                # be consistent with other head.
        ...
        nms_cfg = dict(type="common_nms", iou_threshold=cfg["iou_threshold"])
