...
class FCOSHead(AnchorFreeHead):
    ...
    def forward(self, feats):
        ...
        """
        return multi_apply(self._forward_single, feats, self.scales, self.strides)

    def _forward_single(self, x, scale, stride):
        ...
        """
        cls_score, bbox_pred, cls_feat, reg_feat = super()._forward_single(x)
    ...
    def _get_target_single(
        self, gt_bboxes, gt_labels, points, regress_ranges, num_points_per_lvl
    ):
