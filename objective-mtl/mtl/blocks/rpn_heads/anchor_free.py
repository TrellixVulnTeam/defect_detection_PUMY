...
class AnchorFreeHead(BaseDetHead, BBoxTestMixin):
    ...
    Args:
        ...
        cls_stacked_convs (int): Number of stacking convs of the head.
        reg_stacked_convs (int): Number of stacking convs of the head.
    ...
    def _init_cls_convs(self):
        ...
        for i in range(self.cls_stacked_convs):
            ...
            if self.dcn_on_last_conv and i == self.cls_stacked_convs - 1:
    ...
    def _init_reg_convs(self):
        ...
        for i in range(self.reg_stacked_convs):
            chn = self.in_channels if i == 0 else self.feat_channels
            if self.dcn_on_last_conv and i == self.reg_stacked_convs - 1:
                conv_cfg = dict(type="DCNv2")
            else:
                conv_cfg = self.conv_cfg
        ...
        Returns:
            tuple: Usually contain classification scores and bbox predictions.
                ...
                bbox_preds (list[Tensor]): Box energies / deltas for each scale
                    ...
                    num_points * 4.
        """
        return multi_apply(self._forward_single, feats)[:2]
