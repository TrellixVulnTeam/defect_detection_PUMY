...
from mtl.utils.reg_util import Registry, build_module_from_cfg, build_module_from_dict
    ...
    if isinstance(cfg, list):
        ...
        for cfg_ in cfg:
            if isinstance(cfg_, CfgNode):
                modules.append(build_module_from_cfg(cfg_, registry, default_args))
            else:
                modules.append(build_module_from_dict(cfg_, registry, default_args))
