...
class TextLoggerHook(LoggerHook):
    ...
    def _train_log(self, log_dict, runner):
    ...
    def _get_logitems(self, log_dict):
        log_items = []
    ...
    def _log_info(self, log_dict, runner):
        ...
        if log_dict["mode"] == "train":
            log_str = self._train_log(log_dict, runner)
        else:
            if self.by_epoch:
                log_str = (
        ...
        log_items = self._get_logitems(log_dict)
    ...
    def _dump_log(self, log_dict, runner):
        ...
        if runner.rank == 0:
            with open(self.json_log_path, "a+") as f:
                obj_dump(json_log, f, file_format="json")
                f.write("\n")
