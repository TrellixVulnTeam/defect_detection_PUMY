...
class DetailedLinearWarmUpHook(Hook):
    def __init__(
        self,
        warmup_iters=10000,
        lr_weight_warmup_ratio=0.0,
        lr_bias_warmup_ratio=10.0,
    ...
    def before_run(self, runner):
        ...
        for group_ind, (name, _) in enumerate(runner.model.named_parameters()):
