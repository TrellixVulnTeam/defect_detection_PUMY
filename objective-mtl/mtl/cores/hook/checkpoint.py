...
from mtl.utils.parallel_util import allreduce_params, master_only
...
class CheckpointHook(Hook):
    ...
    def after_train_epoch(self, runner):
        ...
        if isinstance(runner.optimizer, ZeroRedundancyOptimizer):
            runner.optimizer.consolidate_state_dict()
        if runner.rank == 0:
