...
from ...core_bbox import BBOX_ASSIGNERS, build_match_cost
from ..bbox_transforms import bbox_cxcywh_to_xyxy
...
class HungarianAssigner(BaseAssigner):
    ...
    def assign(
        ...
        # print(cls_cost.shape, reg_cost.shape, iou_cost.shape)
        if len(cls_cost.shape) == 1:
            cost = cls_cost[:, None] + reg_cost + iou_cost
        else:
        ...
        if len(cls_cost.shape) == 1:
            assigned_labels[matched_row_inds] = 0
        else:
