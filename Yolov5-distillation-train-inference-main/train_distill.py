...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str,
                        default='/home/zhang/defect_detection/yolov5/runs/train/exp61/weights/best.pt', help='initial weights path')
    parser.add_argument('--teacher', type=str,
                        default='weights/yolov5s.pt', help='teacher weights path')
    ...
    parser.add_argument('--cfg', type=str,
                        default='/home/zhang/defect_detection/yolov5/models/exp/exp61.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str,
                        default='data/PCB_Color.yaml', help='data.yaml path')
    parser.add_argument(
