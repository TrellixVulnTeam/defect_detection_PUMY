import numpy as np
import torch
from models.experimental import attempt_load_withGrad
...
class YOLOV5TorchObjectDetector(nn.Module):
    def __init__(self,
        ...
        self.model = attempt_load_withGrad(model_weight, self.Grad, map_location=device, inplace=False, fuse=False)
