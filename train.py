...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=ROOT / 'configs/yolov5-standard/yolov5m.yaml', help='model.yaml path')
    ...
    parser.add_argument('--name', default='yolov5m_cut640', help='save to project/name')
