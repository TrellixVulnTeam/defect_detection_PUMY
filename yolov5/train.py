...
from models.common import Group_Normal
...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    for v in model.modules():
        ...
        if isinstance(v, nn.BatchNorm2d):  # weight (no decay)
            g0.append(v.weight)
        # if isinstance(v, Group_Normal):  # weight (no decay)
        #     g0.append(v.weight)
    ...
    # plot_lr_scheduler(optimizer, scheduler, epochs, '/home/zhang/defect_detection/yolov5')
    # EMA
